...
public class UsuarioReadRepository : IUsuarioReadRepository
{
    ...
    public async Task<IEnumerable<UsuarioListResponse>> ObterTodosPorEmpresaAsync(Guid empresaId)
    {
        var sql = @"
        ...
        return await connection.QueryAsync<UsuarioListResponse>(sql, new { EmpresaId = empresaId });
    }
}