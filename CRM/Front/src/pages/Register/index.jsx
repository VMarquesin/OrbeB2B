...
export default function CadastroEmpresa() {
  ...
  // Mapeamento exato com os campos utilizados no formulário
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        cidadeId: '25c3604e-b22c-4085-8e33-fe39e39c914a',

        // Remove pontos, barras e hífen do CNPJ
        ...
        nomeResponsavel: formData.nome_admin,
        email: formData.email_admin,
        senha: formData.senha_hash
      };
        ...
        <div className="md:w-1/3 bg-slate-900 p-8 text-white flex flex-col justify-between">
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Configure seu ERP industrial em poucos passos. Gerencie sua
              esteira de produção, orçamentos B2B e DRE em um único ambiente.
            </p>
          </div>
          ...
          <div className="mt-12 space-y-4">
            <div
              className={`flex items-center gap-3 ${
                etapa >= 1 ? 'text-amber-500' : 'text-slate-600'
              }`}
            >
              <CheckCircle2
                size={20}
                className={etapa > 1 ? 'text-emerald-500' : ''}
              />
            ...
            <div
              className={`flex items-center gap-3 ${
                etapa >= 2 ? 'text-amber-500' : 'text-slate-600'
              }`}
            >
              <CheckCircle2
                size={20}
                className={etapa > 2 ? 'text-emerald-500' : ''}
              />
            ...
            <div
              className={`flex items-center gap-3 ${
                etapa >= 3 ? 'text-amber-500' : 'text-slate-600'
              }`}
            >
        ...
        <div className="md:w-2/3 p-8">
          <div className="mb-6">
            ...
            <p className="text-slate-500 text-sm mt-1">
              Preencha os dados de acordo com o cartão CNPJ.
            </p>
          </div>

          <form
            onSubmit={etapa === 3 ? handleSubmit : handleNextStep}
            className="space-y-6"
          >
